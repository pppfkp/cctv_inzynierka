"""
Django settings for cctv_face_recognition_django_service project.
...
SECRET_KEY = 'django-insecure-*8^61c76snv_c!&*2q_x6^io_6&ecxbvtikvgs_fp*4co0i4w='
...
WSGI_APPLICATION = 'cctv_face_recognition_django_service.wsgi.application'
